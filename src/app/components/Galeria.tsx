    ...
    <section className="py-24 bg-[#FDFBF7] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h3 className="text-4xl md:text-5xl font-extrabold text-[#5C4033] mb-4">
            Seguinos en Instagram
          </h3>
          <p className="text-lg text-[#8B7355]">
            <a href="#" className="font-bold text-[#008C45] hover:underline">@elcanonpanaderia</a>
            <br />
        ...
        <ResponsiveMasonry columnsCountBreakPoints={{ 350: 2, 750: 3, 900: 4 }}>
          <Masonry gutter="16px">
            {images.map((img, i) => (
              <div key={i} className="relative group rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                <img
                  src={img}
